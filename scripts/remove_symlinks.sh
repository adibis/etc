...
echo "\033[0;33m"'This operation will only remove symlinks if the backup files exist.'"\033[0m"
echo "\033[0;33m"'Please answer the following questions.\n'"\033[0m"

echo "\033[0;34m"'Do you want to uninstall zsh configuration? (Y/N) (no)'"\033[0m"
read line
if [ "$line" = Y ] || [ "$line" = y ]; then

    echo "\033[0;32m"'\nRemoving the symlinks and restoring backups.'"\033[0m"
...
echo "\033[0;34m"'Do you want to uninstall git configuration? (Y/N) (no)'"\033[0m"
read line
if [ "$line" = Y ] || [ "$line" = y ]; then
...
echo "\033[0;34m"'Do you want to uninstall tmux configuration? (Y/N) (no)'"\033[0m"
read line
if [ "$line" = Y ] || [ "$line" = y ]; then
...
echo "\033[0;34m"'Do you want to uninstall Xresources file? (Y/N) (no)'"\033[0m"
read line
if [ "$line" = Y ] || [ "$line" = y ]; then
